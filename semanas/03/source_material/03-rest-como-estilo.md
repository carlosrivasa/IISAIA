...
Ya sabés que HTTP tiene verbos y códigos de estado. Pero ese repertorio, por sí solo, no te dice cómo armar una API: te dice qué piezas existen, no cómo combinarlas.
...
La regla mental: el verbo dice qué hacer; la URL dice sobre qué. `GET /projects/4` lee el proyecto cuatro; `DELETE /projects/4` lo borra. La URL no cambia según la acción; la acción viaja en el verbo.
