...
| 7 | [07-de-lo-local-al-stack.md](07-de-lo-local-al-stack.md) | Salto al stack local; FastAPI y alternativas; tarea para semana 04 | Salto (~12 min) |
...
La clase también marca el salto del curso: dejamos atrás los entornos web (Canvas) y nos preparamos para trabajar en local. El cierre es un demo en vivo donde el profesor levanta un servidor con Claude Code; los alumnos no escriben código en clase, pero llegan a semana 04 con la herramienta instalada.
